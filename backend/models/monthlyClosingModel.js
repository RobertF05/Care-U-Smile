...
const MonthlyClosing = {
  ...
  // Obtener estadísticas de procedimientos generales
  ...
  // Obtener estadísticas de ortodoncia
  async getOrthodonticsProceduresStats(startDate, endDate, clinicPercentage, doctorPercentage) {
    ...
    return {
      orthodontic_income: clinicIncomeCordobas + doctorIncomeCordobas,
      ...
      total_patient_payment: totalPatientPaymentCordobas,
      procedure_count: data.length
    };
  },
  ...
  // ============================================
  // FUNCIONES CORREGIDAS PARA GASTOS
  // ============================================
  ...
  // 🔴 FUNCIÓN CORREGIDA: Obtener gastos variables del período
  async getVariableExpensesForMonthly(startDate, endDate) {
    ...
    const processedInDaily = (data || []).filter(b => b.processed_in_daily_closing_ID !== null);
    const notProcessed = (data || []).filter(b => b.processed_in_daily_closing_ID === null);
  ...
  // 🔴 FUNCIÓN CORREGIDA: Obtener estadísticas de gastos
  ...
  // Obtener detalles de doctores externos
